...
import static exchange.TestDataInfosystemTest.TestData.CUSTOMER;
import static exchange.TestDataInfosystemTest.TestData.PROSPECT;
import static exchange.ZipCodeEventHandlerTest.closeEditor;
...
public class TestDataInfosystemTest extends EsdkIntegTest {
	...
	enum TestData {
		...
		TestData(final Class<? extends BusinessPartnerEditor> tClass, final String swd, final String address,
				final String zipCode, final String town) {
			this.tClass = tClass;
			this.swd = swd;
